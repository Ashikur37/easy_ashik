        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{URL::to('/')}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
                ...
                <div class="block">
                    <input type="radio" name="appSettingsTabs" id="appSettingsTab3" value="null"/>
                        ...
                        <div class="form-group {{ $errors->has('admin_name') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="admin_name" id="admin_name"  placeholder="Enter Name" />
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error ' : '' }}">
                            <label for="mail_host">Email</label>
                        ...
                        <div class="form-group {{ $errors->has('password') ? ' has-error ' : '' }}">
                            <label for="mail_port">Password</label>
