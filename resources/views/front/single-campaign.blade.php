    ...
    <section class="shop-page">
            ...
            <div class="mt-20 sm-mt-10">
                ...
                {{-- @if ($banner)
                    <div class="banner-img">
                        <img src="{{ asset('/images/category/' . $banner) }}" alt="banner">
                    </div>
                @endif --}}
            </div>
        </div>
        <div class="container">
            <div class="row mt-20 sm-mt-10 white-bg p-20">
                ...
                <h4>
                    {{\App\Model\Vendor::where('user_id',request()->id)->first()->store_name}}
                    ({{\App\Model\Vendor::where('user_id',request()->id)->first()->phone}})
                </h4>
                <a href="{{\App\Model\Vendor::where('user_id',request()->id)->first()->facebook}}"><i class="ri-facebook-fill"></i></a>
                <a href="{{\App\Model\Vendor::where('user_id',request()->id)->first()->instagram}}"><i class="ri-instagram-fill"></i></a>
                <a href="{{\App\Model\Vendor::where('user_id',request()->id)->first()->twitter}}"><i class="ri-twitter-fill"></i></a>
                ...
                @if(isset(request()->id)&&request()->id==0)
                    ...
                    {{$setting->title}}
                    <!--<span class="avater"><img style="width:100px"  alt="{{$setting->title}}" src="{{asset('images/banner/'.$setting->header_logo)}}"></span>-->
                @endif
                </div>
