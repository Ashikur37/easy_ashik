@extends('layouts.admin',['headerText' => $lng->CreateChildCategory])
@section('title', "$lng->CreateChildCategory") 
@section('style')
...
@section('breadcrumb')
    <li class="breadcrumb-item">
        ...
        <a href="#">{{$lng->AddChildCategory}}</a>
    </li>
@endsection
@section('content')
    <div class="container-fluid">
        <form   method="post" action="{{route('child-category.store')}}">
           @csrf
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input  value="{{ old('name') }}" name="name" required type="text" class="form-control" placeholder="{{$lng->Name}}">
                        @error('name')
                    ...
                    <div class="form-group">
                        <label >{{$lng->URL}} </label>
                        <input  value="{{ old('slug') }}" name="slug"  type="text" class="form-control" placeholder="Enter url">
                        @error('slug')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
