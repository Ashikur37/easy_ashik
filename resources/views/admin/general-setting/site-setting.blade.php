@extends('layouts.admin',['headerText' => $lng->SiteSetting])
@section('title', "$lng->SiteSetting")
@section('breadcrumb')
    <li class="breadcrumb-item">
        <i class="ri-arrow-right-s-line"></i>
        <a href="#">{{ $lng->SiteSetting }}</a>
    </li>
@endsection
@section('style')
...
@section('content')
    <div class="container-fluid">
        <form action="{{ URL::to('/admin/site-setting') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        <label>{{ $lng->SiteTitle }}</label>
                        <input required name="title" value="{{ $setting->title }}" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>{{ $lng->ThemeColor }}</label>
                        <input required name="theme_color" value="{{ $setting->theme_color }}" type="color"
                            class="form-control">
                    </div>

                    <div class="form-group">
                        <label>{{ $lng->Contact }}</label>
                        <input required name="contact" value="{{ $setting->contact }}" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>{{ $lng->Mail }}</label>
                        <input required name="mail" value="{{ $setting->mail }}" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>{{ $lng->Address }}</label>
                        <input required name="address" value="{{ $setting->address }}" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>{{ $lng->FooterCopyrightText }}</label>
                        <input required name="copyright_text" value="{{ $setting->copyright_text }}" type="text"
                            class="form-control" value="Copyright Takwasoft.com  All Rights Reserved">
                    </div>
                    <div id="selectWrapper" class="d-none">
                        <div class="form-group">
                            <label>{{ $lng->SupportedCountries }}</label>
                            <select name="supported_countries[]" multiple="multiple" class="select2 form-control">
                                @foreach ($countries as $country)
                                    <option {{ in_array($country, $supportedCountries) ? 'selected' : '' }}>{{ $country }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>{{ $lng->DefaultCountry }}</label>
                            <select name="default_country" class="select2 form-control">
                                @foreach ($countries as $country)
                                    <option {{ $setting->default_country == $country ? 'selected' : '' }}>{{ $country }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>{{ $lng->DefaultLocale }}</label>
                            <select name="default_locale" class="select2 form-control">
                                @foreach ($languages as $language)
                                    <option value="{{ $language->id }}"
                                        {{ $setting->default_locale == $language->id ? 'selected' : '' }}>
                                        {{ $language->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>{{ $lng->DefaultTimezone }}</label>
                            <select name="default_timezone" class="select2 form-control" id="timezone">
                                ...
                                <optgroup label="America">
                                    ...
                                    <option value="America/Argentina/Buenos_Aires">(GMT/UTC - 03:00) Argentina/Buenos Aires
                                    </option>
                                    <option value="America/Argentina/Catamarca">(GMT/UTC - 03:00) Argentina/Catamarca
                                    </option>
                                    ...
                                    <option value="America/Argentina/Rio_Gallegos">(GMT/UTC - 03:00) Argentina/Rio Gallegos
                                    </option>
                                    ...
                                    <option value="America/Indiana/Indianapolis">(GMT/UTC - 05:00) Indiana/Indianapolis
                                    </option>
                                    ...
                                    <option value="America/Kentucky/Louisville">(GMT/UTC - 05:00) Kentucky/Louisville
                                    </option>
                                    <option value="America/Kentucky/Monticello">(GMT/UTC - 05:00) Kentucky/Monticello
                                    </option>
                                    ...
                                    <option value="America/North_Dakota/Beulah">(GMT/UTC - 06:00) North Dakota/Beulah
                                    </option>
                                    <option value="America/North_Dakota/Center">(GMT/UTC - 06:00) North Dakota/Center
                                    </option>
                                    <option value="America/North_Dakota/New_Salem">(GMT/UTC - 06:00) North Dakota/New Salem
                                    </option>
                ...
                <div class="col-md-5 offset-1">
                    ...
                    <div class="form-group mt-5">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>{{ $lng->Newsletter }}</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->is_newsletter ? 'checked' : '' }} name="is_newsletter" type="checkbox"
                    ...
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>{{ $lng->AffiliateWithdraw }}</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->affiliate_withdraw ? 'checked' : '' }} name="affiliate_withdraw"
                    ...
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>{{ $lng->AffiliateShopping }}</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->affiliate_shopping ? 'checked' : '' }} name="affiliate_shopping"
                                    type="checkbox" class="switch ts-swich-input">
                                <span class="ts-swich-body"></span></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>{{ $lng->CookieBar }}</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->is_cookie ? 'checked' : '' }} name="is_cookie" type="checkbox"
                                    class="switch ts-swich-input">
                                <span class="ts-swich-body"></span></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>{{ $lng->GeustCheckout }}</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->guest_checkout ? 'checked' : '' }} name="guest_checkout" type="checkbox"
                                    class="switch ts-swich-input">
                                <span class="ts-swich-body"></span></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>{{ $lng->EmailVerification }}</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->email_verification ? 'checked' : '' }} name="email_verification"
                                    type="checkbox" class="switch ts-swich-input">
                                <span class="ts-swich-body"></span></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>AutoReviewRatingApproval</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->auto_approval_review ? 'checked' : '' }} name="auto_approval_review"
                                    type="checkbox" class="switch ts-swich-input">
                                <span class="ts-swich-body"></span></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <label>{{ $lng->Captcha }}</label>
                            <label class="ts-swich-label">
                                <input {{ $setting->is_captcha ? 'checked' : '' }} name="is_captcha" type="checkbox"
                                    class="switch ts-swich-input">
                                <span class="ts-swich-body"></span></label>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        $(function() {
            ...
            $("#timezone ").select2().val("{{ $setting->default_timezone }}").trigger("change")
        });
