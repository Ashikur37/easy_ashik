@extends('layouts.admin',['headerText' => $lng->FeatureList])
@section('title', "$lng->FeatureList") 
@section('style')
...
@section('breadcrumb')
    <li class="breadcrumb-item">
        ...
        <a href="{{route('attribute.index')}}">{{$lng->FeatureList}}</a>
    </li>
@endsection
@section('content')
            ...
            <div class="flex-item top-info-header">
                <div class="d-flex">
                    <div>
                        ...
                        <a href="{{route('attribute.create')}}" class="submit-btn mr-3">
                            {{$lng->Add}}
                        </a>
                        @endcan
                    </div>
                    <div class="action-wrapper">
                        ...
                        <button class="trash-btn delete-button-head mr-3" data-route="{{URL::to('/admin/attribute/multi')}}">
                                {{$lng->Delete}}
                            </button>
                        @endcan
                    </div>
            ...
            <div class="card card-table">
                <div class="table-responsive">
                    <table class="table table-striped first" id="takwa-table">
                        <thead>
                            <tr>
                                @canany(['attribute.edit','attribute.destroy'])
                                <th>
...
['route' => 'attribute.index','columns'=>[
    auth()->user()->can('attribute.edit')||auth()->user()->can('attribute.destroy')?
        [
        "name"=>'index',
        'order'=>'false'
        ]:null,
