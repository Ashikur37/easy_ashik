@extends('layouts.admin',['headerText' => $lng->ViewOrder])
        ...
        <div class="single__order__page">
            <div class="main-content-wrapper order-details">
                <h4 class="section-title">
                    {{ $lng->OrderDetails }}
                    <a href="{{ URL::to('admin/order/print/' . $order->id) }}" target="_blank">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="address-info-row">
                                ...
                                <div class="info-label">
                                    <form method="post" action="{{URL::to('/admin/order/address/'.$order->id)}}">
                                        @csrf
                                        <textarea class="form-control" name="billing_address_1">{{ $order->billing_address_1 }}</textarea>
                                        
                                        <button class="btn btn-sm btn-info mt-3">Update</button>
                                    </form>
