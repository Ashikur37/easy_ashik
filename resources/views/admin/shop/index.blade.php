@extends('layouts.admin',['headerText' =>"Shop List"])
        ...
        <div class="col-12">
            <div class="flex-item top-info-header">
                <div class="d-flex">
                    <div>
                        @can('shop.create')
                        <a href="{{route('shop.create')}}" class="submit-btn mr-3">
                            {{$lng->Add}}
                        </a>
                        @endcan
                    </div>
                    <div class="action-wrapper">
                        @can('shop.edit')
                        <select class="select2 mr-3 select-status-head" data-route="{{URL::to('/admin/shop/multi')}}">
                        ...
                        @endcan
                        @can('shop.destroy')
                        <button class="trash-btn delete-button-head mr-3" data-route="{{URL::to('/admin/shop/multi')}}">{{$lng->Delete}}</button>
                        @endcan
                    </div>
                </div>               
                <div class="d-flex ">
