...
<div id="ticket-body" class='ticket-body custom-scrollbar'>
    <ul id='conversation'>
        @foreach ($ticket->messages as $message)
            <li class='{{ $message->sender_type == 0 ? 'message-left' : 'message-right' }}'>
...
@if ($ticket->status == 1)
    <form id="ticket-form" action="{{ route('user.ticket-message', $ticket->id) }}">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <span class="input-group-text">
                        <label class="mb-0"><input type="file" name="attachment" hidden><i
