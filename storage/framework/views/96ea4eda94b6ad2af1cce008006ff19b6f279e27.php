...
<h4><i class="ri-shopping-basket-line"></i><span> <?php echo e(Cart::instance('default')->content()->count()); ?> <?php echo e($lng->Items); ?></span></h4>
...
<div class="empty-cart">
    <div class="empty-product">
        ...
        <h4><?php echo e($lng->YourCartIsEmpty); ?></h4>
    </div>
</div>
<?php endif; ?>
<div class="cart-product-content custom-scrollbar" id="ascroll">
    ...
    <div class="product-info">
        <div class="product-img">
            <img src="<?php echo e(asset('images/product')); ?>/<?php echo e($item->options->image); ?>" alt="<?php echo e($item->name); ?>">
        </div>
        <div class="product-content-wrapper">
            <div class="content-flex">
                <a class="product-details" href="<?php echo e(route('front-product.show',$item->options->slug)); ?>">
                    <?php echo e($item->name); ?>

                </a>
                <span class="product-remove" data-row="<?php echo e($item->rowId); ?>" data-id="<?php echo e($item->id); ?>"><i class="ri-delete-bin-line"></i></span>
            </div>
            <div class="content-flex mt-3">
                <div class="product-attributes">
                    <p>৳<?php echo e(App\Model\Product::currencyPriceRate($item->price)); ?> </p>
                ...
                <div class="product-count">
                    <div class="btn-minus" data-id="<?php echo e($item->id); ?>" data-row="<?php echo e($item->rowId); ?>">
                        <button class="counter">
                            <span><i class="ri-subtract-line"></i></span>
                        </button>
                    </div>
                    <input type="text" readonly class="counter-field qty-<?php echo e($item->rowId); ?>" value="<?php echo e($item->qty); ?>">
...
<div class="cart-footer">
    <div class="cart-subtotal">
        <h4 class="mb-0"><?php echo e($lng->SubTotal); ?></h4>
        <span class="cart-sub-total">৳<?php echo e(App\Model\Product::currencyPriceRate(Cart::subtotal())); ?></span>
    </div>
    <div class="cart-action-btn">
        <a href="<?php echo e(route('cart')); ?>" class="default-btn cart-btn">
            <?php echo e($lng->View); ?> <?php echo e($lng->Cart); ?>

        </a> 
        <a href="<?php echo e(route('checkout')); ?>" class="default-btn checkout-btn">
            <?php echo e($lng->Checkout); ?> 
        </a>
    </div>
</div>
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/easy/resources/views/includes/front/cart.blade.php ENDPATH**/ ?>