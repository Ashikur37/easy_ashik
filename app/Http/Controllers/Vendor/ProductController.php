...
class ProductController extends Controller
{
            ...
            return Datatables::of(Product::where('user_id', auth()->user()->id)->latest()->get())
                ...
                ->addColumn('status', function ($row) {
                    ...
                    return '<label class="ts-swich-label d-inline">
                            <input data-href="' . URL::to('vendor/product/status/' . $row->id) . '"  type="checkbox"' . $checked . ' class="switch-status switch ts-swich-input" name="status" id="" value="1">
    ...
    public function create()
    {
        ...
        return view('seller.product.create', compact('colors', 'sizes', 'brands', 'badges', 'categories', 'tags', 'attributeSets'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('seller.product.edit', compact('productTags', 'productBadges', 'colors', 'sizes', 'brands', 'badges', 'categories', 'tags', 'attributeSets', 'product'));
    }
