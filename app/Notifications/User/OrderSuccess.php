...
class OrderSuccess extends Notification
{
    ...
    {
          $via=[];
        if($this->ns->user_mail_order_success){
            array_push($via,'mail');
        }
        if($this->ns->user_db_order_success){
    ...
    public function toMail($notifiable)
    {
        ...
        $message= (new MailMessage)
                    ->line('Your order has been placed successfully at '.$this->order->created_at->format("h:i A d-M-y"))->line('Order details ');
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            "text"=>'Your order has been placed successfully at'.$this->order->created_at->format("h:i A d-M-y"),
